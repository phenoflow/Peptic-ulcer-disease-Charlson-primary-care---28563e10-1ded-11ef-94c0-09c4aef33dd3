...
(async () => {
  ...
  await fs.writeFile("peptic-ulcer-disease-charlson-primary-care-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("peptic-ulcer-disease-charlson-primary-care-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
